        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?php echo base_url(); ?>Welcome/form_validation">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" name="compassword" placeholder="Repeat Password">
                  </div>
                </div>

                <input type="submit" name="insert" value="Register Account" class="btn btn-primary btn-user btn-block">
                <hr>
