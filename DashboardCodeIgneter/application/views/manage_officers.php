                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped">
                            ...
                            <?php if(!empty($officers)){foreach ($officers as $officer){?>
                            </tr>
                                <td><?php echo $officer['officer_id']?></td>
                                <td><?php echo $officer['name']?></td>
                                <td><?php echo $officer['email']?></td>
                                <td>
                                    <a href="<?php echo base_url().'officer/editOfficer/'.$officer['officer_id']?>" class="btn btn-primary">Edit
                                </td>
                                <td> <a href="<?php echo base_url().'officer/deleteOfficer/'.$officer['officer_id']?>" class="btn btn-danger">Delete</td>
