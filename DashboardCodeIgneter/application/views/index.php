      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="Driver/driver_registration">Add Driver</a>
            <hr class="sidebar-divider">
            <a class="collapse-item" href="Driver/viewAllDrivers">Manage Drivers</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="Path/Path_ViewAll">Manage Paths</a>
          </div>
        </div>
      </li>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="Welcome/logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
