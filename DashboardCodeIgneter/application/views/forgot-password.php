            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php echo $this->session->flashdata('forgetpass'); ?>
                    <h1 class="h4 text-gray-900 mb-2">Forgot Your Password?</h1>
                    <p class="mb-4">We get it, stuff happens. Just enter your email address below and we'll send you a link to reset your password!</p>
                  </div>
                  <form class="user" action="<?php echo base_url(); ?>Welcome/resetlink" method="POST">
                    ...
                    <!-- <a href="forget_Recorrect" class="btn btn-primary btn-user btn-block">
                      Reset Password
                    </a> -->
                  </form>
                  <hr>
